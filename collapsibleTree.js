...
treeJSON = d3.json("data.json", function(error,treeData) {
    ...
    var nodeLink = d3.linkHorizontal()
    ...
    //        return b.height - a.height || b.name.toLowerCase() < a.name.toLowerCase() ? 1 : -1;
    //    });
    //}
    //
    //sortTree();
    ...
    var zoomListener = d3.zoom().scaleExtent([1, 4]).on("zoom", zoom);
